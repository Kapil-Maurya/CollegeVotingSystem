        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-image">
                    <img src="can.png" alt="Candidate Image">
                </div>
                <div class="card-details">
                    <h2>1<sup>st</sup> Year</h2>
                    <a href="insert_Candidates.php" class="btn-special-2">Enroll</a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-details">
                    ...
                    <a href="insert_Candidate_2nd.php" class="btn-special-2">Enroll</a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-details">
                    ...
                    <a href="insert_Candidate_3rd.php" class="btn-special-2">Enroll</a>
                </div>
            </div>
        </div>
    </div>
