    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p style="margin-bottom: 50px;">2<sup>nd</sup> Year Candidates</p>
            </div>
            <?php 
            ...
            <div class="col-md-3">
                <div class="card">
                    <img class="card-img-top" src="can.png" alt="Candidate Image" height="250px">
                    <div class="card-body">
