            ...
            <div class="card">
                <div class="row">
                        ...
                        <form action="savedData.php" method="post" id="ConfirmForm"> 
                            <table>
                                <tr>
                                    ...
                                    <td class="td-1"><input type="text" name="txtName" required></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="td-1"><input type="text" name="txtBranch" required></td>
                                </tr>
                                <tr>
                                    <td class="td-1">Mobile Number :</td>
                                    <td class="td-1"><input type="number" name="txtNumber" required pattern="[6-9]{1}[0-9]{9}"></td>
                                </tr>
                                <tr>
                                    <td class="td-1">Which Candidate :</td>
                                    <td class="td-1">
                                        <select name="txtCand" required>
                                            ...
                                            <?php 
                                                ...
                                                foreach ($results as $output) {
                                                    echo '<option value="' . $output["name"] . '">' . $output["name"] . '</option>';
                                                }
                                            ?>
                                        </select>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="td-1"><textarea name="txtReason" cols="23" rows="4" placeholder="Why do you vote for this candidate? Any reason?"></textarea></td>
                                </tr>
                                <tr>
                                    <td colspan="2" class="td-2" style="padding-top: 20px; padding-bottom: 40px;">
                    ...
                    <div class="col-md-6" style="padding-top: 50px;">
                        <img src="can1.png" alt="Candidate Image">
                    </div>
                </div>
            </div>
        </div>
